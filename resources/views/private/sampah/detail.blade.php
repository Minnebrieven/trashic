				...
				<div class="row">
					...
					<div class="col-6 mb-3">
						<div class="d-flex flex-row align-items-center">
							...
							<div class="row ml-1">
								<div class="col-12">
									<h4 class="mb-0"> {{ (!empty($sampah->score) ? $sampah->score.'/'.$sampah->satuan : '-' ) }} </h4>
								</div>
								<div class="col-12">
									<small class="text-muted mb-0">Score/Satuan</small>
								</div>
							</div>
						</div>
					</div>
					<div class="col-6 mb-3">
						<div class="d-flex flex-row align-items-center">
							<i class="bi bi-coin icon-md text-info"></i>
							<div class="row ml-1">
								<div class="col-12">
									<h4 class="mb-0"> {{ (!empty($sampah->coin) ? $sampah->coin.' TC/'.$sampah->satuan : '-' ) }}</h4>
								</div>
								<div class="col-12">
									<small class="text-muted mb-0">Coin/Satuan</small>
								</div>
							</div>
						</div>
					</div>
