...
<div class="page-header">
    <h3 class="page-title"> Tambah Hadiah </h3>
...
<div class="row">
    <div class="col-12 grid-margin stretch-card mt-3">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('hadiah.store') }}" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="coin_diperlukan">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
