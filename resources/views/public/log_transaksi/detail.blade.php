                ...
                <div class="card" style="width:auto">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <div class="d-flex flex-row align-items-center">
                                    <i class="bi bi-award icon-md text-info" style="font-size: 2rem"></i>
                                    &nbsp;&nbsp;
                                    <div class="row ml-1">
                                        <div class="col-12">
                            ...
                            <div class="col-6 mb-3">
                                <div class="d-flex flex-row align-items-center">
                                    <i class="bi bi-coin icon-md text-info" style="font-size: 2rem"></i>
                                    &nbsp;&nbsp;
                                    <div class="row ml-1">
                                        <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                @php
                                    $arrayTitle = ['Sampah', 'Score/sampah', 'Coin/sampah', 'Harga Satuan', 'Jumlah', 'Total'];
                                @endphp
                                    ...
                                    <tbody>
                                        @foreach ($logTransaksi->setoran->detail_setoran as $detailSetoran)
                                            <tr>
                                                ...
                                                <td>{{ $detailSetoran->sampah->coin }} TC</td>
                                                <td>Rp.
